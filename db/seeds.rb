...
It = Book.create!(:title => 'It',
  ...
  :genre => 'Horror', :description => 'Stephen King’s terrifying, classic #1 New York Times bestseller')
TheMartian = Book.create!(:title => 'The Martian',
  :publish_date => '11/2/2014', :isbn => '9789045207858',
  :genre => 'Science fiction', :description => 'Six days ago, astronaut Mark Watney became one of the first people to walk on Mars.')
...
Carrie = Book.create!(:title => 'Carrie',
  ...
  :genre => 'Horror', :description => 'Carrie White may be picked on by her classmates, but she has a gift.')
